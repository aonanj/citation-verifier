...
- **Verification**:
  ...
  - **Federal law**: GovInfo link service with reporter-aware URL building for U.S.C., C.F.R., Stat., Pub. L., Fed. Reg., and related materials. When GovInfo can't confirm a citation (e.g. a section cited with subsections such as `35 U.S.C. § 154(a)(1)-(2)`, the U.S. Constitution, or a public law before the 104th Congress), it is rechecked by the model in `AI_MODEL` with web search limited to uscode.house.gov, Cornell LII, eCFR, GovInfo, the Federal Register, and Congress.gov, as for state law.
