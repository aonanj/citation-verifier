...
export const metadata: Metadata = {
  title: 'Terms of Use',
  description:
    'Terms of Use for CiteSure covering eligibility, payments, acceptable use requirements, confidentiality, and support.',
};
...
const termsSections = [
  {
    ...
    body: [
      'The CiteSure verification service, add-ins, and related documentation are provided by Phaethon Order LLC. By creating an account, initiating a verification request, or otherwise accessing CiteSure, you confirm that you have authority to bind your organization and agree to comply with these Terms of Use.',
  ...
  },
  {
    ...
    body: [
      ...
      'Notify support@phaethon.llc immediately if you suspect unauthorized access, credential compromise, or changes to the status of the individuals who use CiteSure on your behalf.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'You may not reverse engineer, probe for vulnerabilities, or attempt to access systems or data outside the scope of the CiteSure service. Scraping or automated querying of application endpoints is prohibited.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'CiteSure is provided on an “as-is” and “as-available” basis. While our verification pipeline aggregates multiple authoritative sources, we do not guarantee the completeness or absolute accuracy of results.',
  ...
  },
  {
    ...
    body: [
      'To the maximum extent permitted by law, Phaethon Order LLC is not liable for indirect, incidental, special, consequential, or punitive damages, or for loss of profits or revenue, arising from your use of CiteSure.',
      'Total liability for any claim under these Terms will not exceed the amount you paid to CiteSure for the applicable verification credits in the twelve months preceding the event giving rise to the claim.',
    ],
  },
  {
    heading: '9. Suspension & Termination',
    body: [
      'We may suspend or terminate access to CiteSure if you violate these Terms, misuse the service, or create risk of liability for other users. You may terminate your account at any time by contacting support@phaethon.llc; unused credits are forfeited upon termination unless otherwise required by law.',
    ],
  },
  {
    heading: '10. Updates to These Terms',
    body: [
      'We may update these Terms from time to time. Material changes will be posted in the application footer and emailed to account administrators. Continued use of CiteSure after an update constitutes acceptance of the revised Terms.',
    ],
  },
];
    ...
    <main className={styles.page}>
      <div className={styles.container}>
        <header className={styles.header}>
          <span className={styles.eyebrow}>CiteSure Legal</span>
          <h1 className={styles.title}>Terms of Use</h1>
          <p className={styles.subtitle}>
            These Terms govern access to and use of CiteSure citation verification services, add-ins, and supporting
            documentation.
          </p>
