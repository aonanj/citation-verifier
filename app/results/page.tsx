...
export default function ResultsPage() {
  ...
  const handleExportPDF = () => {
    ...
    try {
      ...
      doc.setFont('helvetica', 'bold');
      doc.setFontSize(18);
      doc.text('JurisCheck Verification Report', margin, cursorY);
      cursorY += 26;
      ...
      doc.save(`jurischeck-report-${timestampSlug}.pdf`);
    } catch (error) {
    ...
    return (
      <div className={styles.authGate}>
        <div className={styles.authGateCard}>
          <span className={styles.authGateLabel}>JurisCheck</span>
    ...
    return (
      <div className={styles.authGate}>
        <div className={styles.authGateCard}>
          ...
          <p className={styles.authGateDescription}>
            Please sign in to continue with JurisCheck...
          </p>
